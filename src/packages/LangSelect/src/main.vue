<template>
  <el-dropdown trigger="click" class='international' @command="handleSetLanguage">
    <div>
      <gl-svg-icon class-name='international-icon' icon-class="language" />
      <!-- <svg t="1509704884729" class="international-ico"  viewBox="0 0 1088 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" 
       p-id="6279" xmlns:xlink="http://www.w3.org/1999/xlink" width="25" height="25">
       <path d="M729.6 294.4c19.2 57.6 44.8 102.4 89.6 147.2 38.4-38.4 64-89.6 83.2-147.2h-172.8zM307.2 614.4h166.4L390.4 390.4z" 
       p-id="6280"></path>
