<template>
  <div class="sys-settings">
      <span>
        <svg t="1530350627066" @click="handleSetVisible" class="settings-svg" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" 
        p-id="1081" xmlns:xlink="http://www.w3.org/1999/xlink" width="200" height="200">
